...
PolygonVertexStart(2,1) = round(PatternVertex(iSeg,1) + PenWidth/2 + PenWidth*((2-sqrt(3))/sqrt(3)));
...
PolygonVertexEnd(3,1) = round(PatternVertex(iSeg+1,1) + PenWidth/sqrt(3));
PolygonVertexEnd(3,2) = round(PatternVertex(iSeg+1,2));

PolygonVertexEnd(4,1) = round(PatternVertex(iSeg+1,1));
PolygonVertexEnd(4,2) = round(PatternVertex(iSeg+1,2) - PenWidth);
...
PolygonVertexEnd(4,1) = round(PatternVertex(iSeg+1,1) - PenWidth/2 - PenWidth*((2-sqrt(3))/sqrt(3)));
...
PolygonVertexStart(3,1) = round(PatternVertex(iSeg,1) - PenWidth/2 - PenWidth*((3-sqrt(3))/sqrt(3)) );
PolygonVertexStart(3,2) = round(PatternVertex(iSeg,2) - PenWidth/2);

PolygonVertexStart(4,1) = round(PatternVertex(iSeg,1) - PenWidth/2 - PenWidth*((2-sqrt(3))/sqrt(3)));
PolygonVertexStart(4,2) = round(PatternVertex(iSeg,2) + PenWidth/2);
...
PolygonVertexEnd(3,1) = round(PatternVertex(iSeg+1,1) - PenWidth/2 + PenWidth/sqrt(3));
PolygonVertexEnd(3,2) = round(PatternVertex(iSeg+1,2) - PenWidth/2);
