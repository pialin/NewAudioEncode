...
%初始4个顶点
PolygonVertexStart(1,1) = round(PatternVertex(iSeg,1) - PenWidth/2 + PenWidth/sqrt(3));
PolygonVertexStart(1,2) = round(PatternVertex(iSeg,2) - PenWidth/2);

PolygonVertexStart(2,1) = round(PatternVertex(iSeg,1) + PenWidth/2 + PenWidth/sqrt(3));
...
%结束时4个顶点
PolygonVertexEnd(1,1) = round(PatternVertex(iSeg+1,1));
PolygonVertexEnd(1,2) = round(PatternVertex(iSeg+1,2) - PenWidth);

PolygonVertexEnd(2,1) = round(PatternVertex(iSeg+1,1) + PenWidth/sqrt(3));
PolygonVertexEnd(2,2) = round(PatternVertex(iSeg+1,2));


PolygonVertexEnd(3,1) = round(PatternVertex(iSeg,1) + PenWidth/2);
PolygonVertexEnd(3,2) = round(PatternVertex(iSeg,2) + PenWidth/2);

PolygonVertexEnd(4,1) = round(PatternVertex(iSeg,1) - PenWidth/2);
PolygonVertexEnd(4,2) = round(PatternVertex(iSeg,2) + PenWidth/2);
...
%初始4个顶点
PolygonVertexStart(1,1) = round(PatternVertex(iSeg,1) - PenWidth/sqrt(3));
PolygonVertexStart(1,2) = round(PatternVertex(iSeg,2));

PolygonVertexStart(2,1) = round(PatternVertex(iSeg,1));
PolygonVertexStart(2,2) = round(PatternVertex(iSeg,2) - PenWidth);


PolygonVertexStart(3,1) = round(PatternVertex(iSeg,1) + PenWidth/sqrt(3));
PolygonVertexStart(3,2) = round(PatternVertex(iSeg,2));

PolygonVertexStart(4,1) = round(PatternVertex(iSeg,1));
PolygonVertexStart(4,2) = round(PatternVertex(iSeg,2) + PenWidth);

%结束时4个顶点
PolygonVertexEnd(1,1) = round(PatternVertex(iSeg,1) - PenWidth/sqrt(3));
PolygonVertexEnd(1,2) = round(PatternVertex(iSeg,2));

PolygonVertexEnd(2,1) = round(PatternVertex(iSeg,1));
PolygonVertexEnd(2,2) = round(PatternVertex(iSeg,2) - PenWidth);
...
PolygonVertexStart(3,1) = round(PatternVertex(iSeg,1) + PenWidth/2 - PenWidth/sqrt(3) );
PolygonVertexStart(3,2) = round(PatternVertex(iSeg,2) - PenWidth/2);
...
%结束时4个顶点
PolygonVertexEnd(1,1) = round(PatternVertex(iSeg+1,1) - PenWidth/2);
PolygonVertexEnd(1,2) = round(PatternVertex(iSeg+1,2) + PenWidth/2);

PolygonVertexEnd(2,1) = round(PatternVertex(iSeg+1,1) - PenWidth/2 +PenWidth/sqrt(3));
PolygonVertexEnd(2,2) = round(PatternVertex(iSeg+1,2) - PenWidth/2);


PolygonVertexEnd(3,1) = round(PatternVertex(iSeg,1) + PenWidth/2 -PenWidth/sqrt(3));
PolygonVertexEnd(3,2) = round(PatternVertex(iSeg,2) - PenWidth/2);
