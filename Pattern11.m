...
PolygonVertexEnd(2,1) = round(PatternVertex(iSeg+1,1) + PenWidth/2 - PenWidth);
...
%初始4个顶点
PolygonVertexStart(1,1) = round(PatternVertex(iSeg,1) - PenWidth/2 - PenWidth*sqrt(2));
PolygonVertexStart(1,2) = round(PatternVertex(iSeg,2) - PenWidth/2);

PolygonVertexStart(2,1) = round(PatternVertex(iSeg,1) + PenWidth/2 - PenWidth);
PolygonVertexStart(2,2) = round(PatternVertex(iSeg,2) - PenWidth/2);
...
PolygonVertexStart(4,1) = round(PatternVertex(iSeg,1) - PenWidth/2 - PenWidth*(sqrt(2)-1));
PolygonVertexStart(4,2) = round(PatternVertex(iSeg,2) + PenWidth/2);
...
PolygonVertexEnd(2,1) = round(PatternVertex(iSeg+1,1) + PenWidth/2 + PenWidth*(sqrt(2)-1));
PolygonVertexEnd(2,2) = round(PatternVertex(iSeg+1,2) - PenWidth/2);
...
PolygonVertexEnd(4,1) = round(PatternVertex(iSeg,1) - PenWidth/2 -PenWidth*(sqrt(2)-1));
PolygonVertexEnd(4,2) = round(PatternVertex(iSeg,2) + PenWidth/2);
...
PolygonVertexStart(2,1) = round(PatternVertex(iSeg,1) + PenWidth/2 + PenWidth*(sqrt(2)-1));
PolygonVertexStart(2,2) = round(PatternVertex(iSeg,2) - PenWidth/2);


PolygonVertexStart(3,1) = round(PatternVertex(iSeg,1) + PenWidth/2 + PenWidth*sqrt(2) );
PolygonVertexStart(3,2) = round(PatternVertex(iSeg,2) + PenWidth/2);

PolygonVertexStart(4,1) = round(PatternVertex(iSeg,1) - PenWidth/2 + PenWidth);
PolygonVertexStart(4,2) = round(PatternVertex(iSeg,2) + PenWidth/2);
...
PolygonVertexEnd(2,1) = round(PatternVertex(iSeg+1,1) + PenWidth/2 );
PolygonVertexEnd(2,2) = round(PatternVertex(iSeg+1,2) - PenWidth/2);
...
PolygonVertexEnd(4,1) = round(PatternVertex(iSeg,1) - PenWidth/2 + PenWidth);
PolygonVertexEnd(4,2) = round(PatternVertex(iSeg,2) + PenWidth/2);
